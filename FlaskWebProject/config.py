...
class Config(object):
    ...
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'fAAGRVqdsUeu1u10BXc+Eygt0vCjM87i1lIs3h6KaEDXcapz7aGD/mppAXpe9gs+0EokPBb+k1NT+AStPk0DBg=='
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'azureuser' or 'jashan'
    ...
    Application (client) ID = "f610c541-0f30-4182-8e5f-ddf47b5e2c48"

    Object ID = "5f6ddfc4-5649-4f68-9cd0-873afd5cc9ef"

    value : unV8Q~uba9ceFRtrQjLvv8XRIyjGvxKSIq_t9cze
